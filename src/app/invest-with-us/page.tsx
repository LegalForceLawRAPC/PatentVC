      ...
      <section className="grid gap-10 pb-[120px] pt-[24px] lg:grid-cols-[685px_348px] lg:items-start lg:justify-between lg:gap-[133px] lg:pt-[24px]">
        <div className="pt-[96px]">
          ...
          <div className="mt-[90px] flex flex-wrap items-center gap-[24px]">
            <Link href={investPage.primaryCta.href} className="inline-flex h-[60px] w-[289px] items-center justify-center rounded-[10px] bg-[#f5744c] font-gilroy-bold text-[18px] text-white transition hover:bg-[#f8845f]">
...
function StatCircle({
  ...
  return (
    <div className={large ? "flex size-[188px] flex-col items-center justify-center rounded-full border-[4px] border-[#f5744c] bg-white text-center" : "flex size-[110px] flex-col items-center justify-center rounded-full bg-white text-center"}>
